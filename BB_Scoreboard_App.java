 ...
 * Git: https://github.com/nicotaglia14/personal_java_projects.git
...
public class BB_Scoreboard_App {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			System.out.println(e.getMessage());
			System.out.println("Sorry but this program ended with an error. Please contact Nicolas Tagliafichi!");
		}
